...
if (mysqli_num_rows($result) > 0){
	while($row = mysqli_fetch_assoc($result)) {
		if($row["id"] == "I006"){
			...
			$image = $row["image"];
			echo "<tr>";
			echo "<td>" . "<img src=" . $image . " style = 'width:600px;height:520px;''>" . "</td>";
			echo "<td width = '15%'>" . $product . "</td>";
			echo "<td width = '7%'>" . "£" . $money . "</td>";
			echo "<td>" . $desc . "</td>"; 
			echo "</tr>";
		}
	}
...
<img class = "firstimage" src="msi.png" style = 'width:110px;height:60px;''>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ofhLEERDeAQ" frameborder="0" allowfullscreen></iframe>
