...
if (mysqli_num_rows($result) > 0){
	while($row = mysqli_fetch_assoc($result)) {
		if($row["id"] == "I002"){
			...
			$image = $row["image"];
			echo "<tr>";
			echo "<td>" . "<img src=" . $image . " style = 'width:600px;height:420px;''>" . "</td>";
...
<img class = "firstimage" src="hp.png" style = 'width:40px;height:40px;''>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/U6WpjeA8gx8" frameborder="0" allowfullscreen></iframe>
