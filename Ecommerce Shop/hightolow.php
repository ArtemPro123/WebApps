 ...
 <html>  
      <head>  
           ...
           <link rel="stylesheet" type="text/css" href="Hcartcss.css" />
      </head>  
      <body>  
      ...
      <br>
            ...
            <br>
            <input type="radio" name="sortBy" value="lowHigh" /><label>Price Low - High</label>
            <br>
            <input type="radio" name="sortBy" value="highlow" checked="checked" /><label>Price High - Low</label>
            <br>
